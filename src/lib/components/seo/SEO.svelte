<script lang="ts">
  // TODO: (soon) Redesign to use: // Per Svelte's documentation: A common pattern is to return SEO-related data from page load functions, then use it (as page.data) in a <svelte:head> in your root layout. https://kit.svelte.dev/docs/load#page-data
